...
TEST(Foundation_metaschema, embedded_custom_metaschema_chain_precedence) {
  const auto schema{sourcemeta::core::parse_json(R"JSON({
    "$schema": "https://example.com/meta-a",
    "$id": "https://example.com/schema",
    "type": "string",
...
TEST(Foundation_metaschema, try_embedded_chain_intermediate_precedence) {
  const auto document{sourcemeta::core::parse_json(R"JSON({
    "$schema": "https://example.com/meta-a",
    "$id": "https://example.com/schema",
    "$defs": {
...
TEST(Foundation_metaschema, try_embedded_chain_intermediate_precedence_cyclic) {
  const auto document{sourcemeta::core::parse_json(R"JSON({
    "$schema": "https://example.com/meta-a",
    "$id": "https://example.com/schema",
    "$defs": {
...
TEST(Foundation_metaschema,
     try_embedded_chain_intermediate_precedence_base_dialect) {
  const auto document{sourcemeta::core::parse_json(R"JSON({
    "$schema": "https://example.com/meta-a",
    "$id": "https://example.com/schema",
    "$defs": {
