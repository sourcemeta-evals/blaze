...
TEST(Compiler_output_simple, contains_annotation_dropping) {
  const sourcemeta::core::JSON schema{sourcemeta::core::parse_json(R"JSON({
    "$schema": "https://json-schema.org/draft/2020-12/schema",
    "contains": { 
      "type": "number",
...
TEST(Compiler_output_simple, contains_annotation_dropping_all_fail) {
  const sourcemeta::core::JSON schema{sourcemeta::core::parse_json(R"JSON({
    "$schema": "https://json-schema.org/draft/2020-12/schema",
    "contains": { 
      "type": "number",
...
TEST(Compiler_output_simple, contains_annotation_dropping_multiple_matches) {
  const sourcemeta::core::JSON schema{sourcemeta::core::parse_json(R"JSON({
    "$schema": "https://json-schema.org/draft/2020-12/schema",
    "contains": { 
      "type": "number",
  ...
  const sourcemeta::core::JSON instance{
      sourcemeta::core::parse_json(R"JSON([ "foo", 42, 3.14, true ])JSON")};
  ...
  EXPECT_ANNOTATION_ENTRY(output, "/1", "/contains/title", "#/contains/title",
                          1);
  EXPECT_ANNOTATION_VALUE(output, "/1", "/contains/title", "#/contains/title",
                          0, sourcemeta::core::JSON{"NumberTitle"});
