...
TEST(Output_standard_basic, with_positions_annotations) {
  ...
  // The root object starts at line 1, column 1 and ends at line 3, column 1
...
TEST(Output_standard_basic, with_positions_errors) {
  ...
  // The value at /foo starts at line 2, column 3 and ends at line 2, column 10
...
TEST(Output_standard_basic, with_positions_flag_format) {
  ...
  // Flag format doesn't include positions, just valid status
  const auto expected{sourcemeta::core::parse_json(R"JSON({
    "valid": true
  })JSON")};
...
TEST(Output_standard_basic, with_positions_nested_error) {
  ...
  // The value at /outer/inner starts at line 3, column 5 and ends at line 3,
  // column 27
