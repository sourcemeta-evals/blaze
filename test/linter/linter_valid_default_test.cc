...
// sibling to $ref, so we skip validation in that case
TEST(Linter, valid_default_13_draft7_ref_sibling) {
  sourcemeta::core::SchemaTransformer bundle;
  bundle.add<sourcemeta::blaze::ValidDefault>(
      sourcemeta::blaze::default_schema_compiler);
...
TEST(Linter, valid_default_14_draft6_ref_sibling) {
  sourcemeta::core::SchemaTransformer bundle;
  bundle.add<sourcemeta::blaze::ValidDefault>(
      sourcemeta::blaze::default_schema_compiler);
...
TEST(Linter, valid_default_15_draft4_ref_sibling) {
  sourcemeta::core::SchemaTransformer bundle;
  bundle.add<sourcemeta::blaze::ValidDefault>(
      sourcemeta::blaze::default_schema_compiler);
...
// In 2019-09 and 2020-12, $ref siblings are processed, so invalid defaults
// should be removed
TEST(Linter, valid_default_16_2019_09_ref_sibling_invalid) {
  sourcemeta::core::SchemaTransformer bundle;
  bundle.add<sourcemeta::blaze::ValidDefault>(
      sourcemeta::blaze::default_schema_compiler);
...
TEST(Linter, valid_default_17_2020_12_ref_sibling_invalid) {
  sourcemeta::core::SchemaTransformer bundle;
  bundle.add<sourcemeta::blaze::ValidDefault>(
      sourcemeta::blaze::default_schema_compiler);
