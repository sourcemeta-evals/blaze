...
// sibling to $ref, so we should not lint in that case
TEST(Linter, valid_examples_draft7_ref_sibling) {
  sourcemeta::core::SchemaTransformer bundle;
  bundle.add<sourcemeta::blaze::ValidExamples>(
      sourcemeta::blaze::default_schema_compiler);
...
TEST(Linter, valid_examples_draft6_ref_sibling) {
  sourcemeta::core::SchemaTransformer bundle;
  bundle.add<sourcemeta::blaze::ValidExamples>(
      sourcemeta::blaze::default_schema_compiler);
...
// In 2019-09 and 2020-12, $ref siblings ARE processed, so we SHOULD lint
TEST(Linter, valid_examples_2019_09_ref_sibling_invalid) {
  sourcemeta::core::SchemaTransformer bundle;
  bundle.add<sourcemeta::blaze::ValidExamples>(
      sourcemeta::blaze::default_schema_compiler);
...
TEST(Linter, valid_examples_2020_12_ref_sibling_invalid) {
  sourcemeta::core::SchemaTransformer bundle;
  bundle.add<sourcemeta::blaze::ValidExamples>(
      sourcemeta::blaze::default_schema_compiler);
