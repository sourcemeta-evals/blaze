...
TEST(Linter, valid_examples_draft_7_ref_sibling_examples) {
  sourcemeta::core::SchemaTransformer bundle;
  bundle.add<sourcemeta::blaze::ValidExamples>(
      sourcemeta::blaze::default_schema_compiler);
...
TEST(Linter, valid_examples_draft_6_ref_sibling_examples) {
  sourcemeta::core::SchemaTransformer bundle;
  bundle.add<sourcemeta::blaze::ValidExamples>(
      sourcemeta::blaze::default_schema_compiler);
...
TEST(Linter, valid_examples_2019_09_ref_sibling_examples_invalid) {
  sourcemeta::core::SchemaTransformer bundle;
  bundle.add<sourcemeta::blaze::ValidExamples>(
      sourcemeta::blaze::default_schema_compiler);
...
TEST(Linter, valid_examples_2020_12_ref_sibling_examples_invalid) {
  sourcemeta::core::SchemaTransformer bundle;
  bundle.add<sourcemeta::blaze::ValidExamples>(
      sourcemeta::blaze::default_schema_compiler);
