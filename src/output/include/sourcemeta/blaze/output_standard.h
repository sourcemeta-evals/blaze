...
/// error and annotation output units with line/column instance position
/// information obtained from a PointerPositionTracker. Each unit will include
/// an `instancePosition` array property with the format `[ lineStart,
