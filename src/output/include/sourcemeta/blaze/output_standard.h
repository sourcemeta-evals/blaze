...
/// error and annotation units with instance position information obtained
/// from a PointerPositionTracker. The `instancePosition` property is an
/// array of the form `[ lineStart, columnStart, lineEnd, columnEnd ]`.
auto SOURCEMETA_BLAZE_OUTPUT_EXPORT
standard(Evaluator &evaluator, const Template &schema,
         const sourcemeta::core::JSON &instance, const StandardOutput format,
