...
/// line/column position information. When provided with a
/// PointerPositionTracker that was used to parse the instance, error and
/// annotation unit objects will include an `instancePosition` array property
/// with the format
