...
/// line/column position information for instance locations. The
/// `instancePosition` array property (`[ lineStart, columnStart, lineEnd,
/// columnEnd ]`) is added to error and annotation unit objects when position
...
/// assert(result.at("errors").at(0).defines("instancePosition"));
///
