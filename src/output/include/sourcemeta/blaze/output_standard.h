...
/// columnStart, lineEnd, columnEnd]` for the instance location.
///
/// ```cpp
/// #include <sourcemeta/blaze/compiler.h>
/// #include <sourcemeta/blaze/evaluator.h>
...
///     sourcemeta::core::default_schema_compiler)};
///
/// std::istringstream instance_stream{R"JSON({"foo": 123})JSON"};
/// sourcemeta::core::PointerPositionTracker tracker;
/// const auto instance{sourcemeta::core::parse_json(instance_stream,
///     std::ref(tracker))};
///
/// sourcemeta::blaze::Evaluator evaluator;
///
