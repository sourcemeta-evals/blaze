...
static auto
position_to_json(const sourcemeta::core::PointerPositionTracker::Position &pos)
    -> sourcemeta::core::JSON {
  auto result{sourcemeta::core::JSON::make_array()};
  result.push_back(
      sourcemeta::core::JSON{static_cast<std::int64_t>(std::get<0>(pos))});
  result.push_back(
      sourcemeta::core::JSON{static_cast<std::int64_t>(std::get<1>(pos))});
  result.push_back(
      sourcemeta::core::JSON{static_cast<std::int64_t>(std::get<2>(pos))});
  result.push_back(
      sourcemeta::core::JSON{static_cast<std::int64_t>(std::get<3>(pos))});
  return result;
}
